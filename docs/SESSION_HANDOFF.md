...
**Nierozstrzygnięte**: `raport-site/v1/index.html` (starszy snapshot, wciąż z liczbami sprzed naprawy Kroku 2 i starym, nieaktualnym zdaniem o "dedicated tax-withholding accounts") — nie wiadomo, czy to celowe archiwum czy przeoczenie; nie ruszone, czeka na decyzję użytkownika. `raport-site/index.html` ma niezacommitowaną zmianę (poprawka zdania) — **nie zacommitowane/niewypchnięte do `github.com/Maykel84/raport.git`**.
